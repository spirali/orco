...
from orco.internals.joboptions import JobOptions
from orco.internals.tasktools import resolve_task_keys, task_to_taskkey, collect_task_keys
...
class Executor:
    ...
    def __init__(self, runtime, name=None, heartbeat_interval=7, n_processes=None):
        ...
        #super().__init__("local", "{} cpus".format(multiprocessing.cpu_count()),
        #                 heartbeat_interval)
